...
export const SAMPLE_PRODUCTS = (categoryMap: Record<string, string>): Omit<Product, 'id'>[] => [
  {
    ...
    bulbType: 'Dahili Göz Koruyucu SMD LED',
    powerConsumption: '5W Enerji Tasarruflu LED (5V Type-C)',
    cableLength: '120 cm Type-C Örgülü Şarj Kablosu',
    energyClass: 'A++',
    featured: true,
    isNewArrival: true,
  ...
  },
  {
    ...
    bulbType: 'E27 Standart Vidalı Duy (Rustik Filament LED Uyumlu)',
    powerConsumption: '8W Vintage LED Ampul (220V - 240V)',
    cableLength: '200 cm Altın Sarısı İtalyan Tekstil Örgülü Kablo (Ara Puar Anahtarlı)',
    energyClass: 'A+',
    featured: true,
    isNewArrival: true,
  ...
  },
  {
    ...
    bulbType: 'E27 Porselen Duy (Maks. 40W Akkor veya 12W LED)',
    powerConsumption: '12W LED veya maks. 40W Halojen/Filament (220V)',
    cableLength: '150 cm Yüksekliği Ayarlanabilir Güçlendirilmiş Çelik Halatlı Tekstil Kablo',
    energyClass: 'A++',
    featured: true,
    isNewArrival: false,
  ...
  },
  {
    ...
    bulbType: 'Entegre 3 Kademeli Dokunmatik LED Modül',
    powerConsumption: '3.5W Ultra Düşük Güç Tüketimi (Dahili 4000mAh Batarya)',
    cableLength: '100 cm Type-C Hızlı Şarj Kablosu',
    energyClass: 'A+++',
    featured: false,
    isNewArrival: true,
